...
-->
[Go to lab 01](AZ-040-Lab-01.md#_)
[Go to lab 02](AZ-040-Lab-02.md#_)
[Go to lab 03](AZ-040-Lab-03.md#_)
[Go to lab 04](AZ-040-Lab-04.md#_)
[Go to lab 05](AZ-040-Lab-05.md#_)
[Go to lab 06](AZ-040-Lab-06.md#_)
[Go to lab 07](AZ-040-Lab-07.md#_)
[Go to lab 08](AZ-040-Lab-08.md#_)
[Go to lab 09](AZ-040-Lab-09.md#_)
[Go to lab 10](AZ-040-Lab-10.md#_)
[Go to lab 11](AZ-040-Lab-11.md#_)
###### _
...
1. Use `$mktgUsers` to identify the number of users in the Marketing department.
    ...
    ``` 
    # All collections (arrays) automatically have a Count property as part of the collection
    ```
    </Strong></details> 
    <details><summary>Click to see the answer</summary><Strong> 
...
1. Create a hash table named `$mailList` with the following users and email addresses:
   ...
   - User **Matej** with the email address **MStojanov@tailspintoys.com**
    ...
    ``` 
    # Hash tables are created with this construct @{Name = 'Value'}
    ```
    </Strong></details> 
    <details><summary>Click to see the answer</summary><Strong> 
