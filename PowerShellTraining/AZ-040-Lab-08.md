...
1. Use remoting to run the command on both **LON-SVR1** and **LON-DC1**.
    <details><summary>Click for hint</summary><Strong> 
...
3. Import the module to your local computer, and then add the prefix **DC** to the nouns for each imported command.
    <details><summary>Click for hint</summary><Strong> 
...
3. Use remoting to run the **Get-WmiObject** command against both **LON-DC1** and **LON-SVR1**. Don't add a **–ComputerName** parameter to the **Get-WmiObject** command.
    <details><summary>Click to see the answer</summary><Strong> 
