...
1. On **LON-CL1**, select **Start**, and then enter **pwsh**.
1. In the results list, right-click **PowerShell 7** or activate its context menu, and then select **Run as administrator**.
1. To install the **AzureAD** module from PowerShell Gallery, in the **Administrator: Windows PowerShell** console, enter the following command, and then select Enter:
...
1. To create a **PasswordProfile** object, in the **Windows PowerShell** console:
    ...
    ``` 
    # To find object types in PowerShell 
    ```
    </Strong></details> 
    <details><summary>Click to see the answer</summary><Strong> 
