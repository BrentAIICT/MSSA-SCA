...
- Use Azure Cloud Shell to create a resource group.
    ...
    > You could use the modules you have downloaded in the previous task
    > However this next exercise give you experience in running the 
    > PowerShell commands from the Clous Shell, meaning you do not have 
    > to install the Az Modules
