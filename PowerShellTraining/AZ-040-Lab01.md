...
1. In the Windows PowerShell console, enter the following command, and then select Enter: <details><summary>Click to see the answer</summary><Strong> ``` Start-Transcript C:\DayOne.txt ```</Strong></details> 
